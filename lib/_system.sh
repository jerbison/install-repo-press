...
system_git_clone() {
  ...
  sudo su - owenzap <<EOF
  # git clone https://github.com/whaticket/whaticket-community  /home/owenzap/${instancia_add}/
    git clone https://github.com/rtenorioh/Press-Ticket  /home/owenzap/${instancia_add}/
EOF
